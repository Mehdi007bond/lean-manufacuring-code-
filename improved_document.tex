...
\newpage
\section{Typologie des Problèmes Industriels}
...
\subsection{Performance Détaillée}
...
Après avoir réalisé des graphiques quantitatifs on peut passer à la partie d'implantation par cela on trouve que les produits ayant le plus grand impact sont P02 et P10 c'est pour cela on a décidé de zoomer et voir la partie temporelle :
